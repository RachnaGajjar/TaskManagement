...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="card mb-g">
        ...
        <div class="row">
            <div class="col-12">
            <form action="{{ route('employeesleave.employeeleaveUpdate',$employeeleave->id) }}" method="POST" id="employees_form">
                    @csrf
                    @method('PUT')
                        ...
                        <input type="text" id="status" name="status" class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}" value="{{$employeeleave->status}}  {{ $employeeleave->status ? '' : 'disabled' }}" placeholder="status">
