            ...
            <aside class="page-sidebar">
                <div class="page-logo">
                    <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                        <img src="{{asset('img/logo.png')}}" alt="Employee_Task_Management" aria-roledescription="logo">
                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        ...
                        <li>
                            <a href="{{ route('organizations.index') }}" title="Application Intel" data-filter-tags="application intel">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">Organization</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('employees.index') }}" title="Application Intel" data-filter-tags="application intel">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">Employee</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('/employeestask/index')}}" title="Application Intel" data-filter-tags="application intel">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">EmployeesTask</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('employeeleave/AdminIndex') }}" title="Application Intel" data-filter-tags="application intel">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">EmployeesLeave</span>
                            </a>
                        </li>
            ...
            <div class="page-content-wrapper">
                ...
                <footer class="page-footer" role="contentinfo">
                    <div class="d-flex align-items-center flex-1 text-muted">
                        <span class="hidden-md-down fw-700">2019 © Employee_Task_Management by&nbsp;<a href='https://www.trootech.com/' class='text-primary fw-500' title='Trootech.com' target='_blank'>Trootech.com</a></span>
                    </div>
                    <div>
